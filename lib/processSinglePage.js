...
export const functions = [
  ...
  },
  {
    ...
    description:
      "This is the second run of the same function, we have included the questions and answers we generated from the first pass so you don't repeat those. You are still the professor of the subject of this wikipedia page, provide a list of at least 5 questions and answers that are the most important elements of this subject. Use a mix of comparative, predictive, why & how, scenario-based, and application-focused questions to generate rich, informative FAQs beyond simple summaries. Examples include: “How did [Leader A]’s strategy differ from [Leader B]’s?” (comparative), “If [event] had unfolded differently, how might it have changed [outcome]?” (predictive), and “How would the world be different if [event] did not happen?” (hypothetical). Make sure that you answer with details, like names, dates, places, references, and so forth.",
    parameters: {
      type: "object",
      properties: {
        title: {
